...
presenters:
  ...
  - links:
      - linkText: A link to nowhere
        linkURL: 'https://www.google.com'
    name: Some Name
    presentationTitle: How to Present Presentations
    text: >-
      This text should go all the way to the end otherwise the thing in the
      middle doesn't wrap properly.
location:
